...
import styles from "./ParallaxRevealCompound.module.css";
...
function ParallaxRevealCompound({ children }: Props) {
...
ParallaxRevealCompound.Slide = Slide;

export default ParallaxRevealCompound;